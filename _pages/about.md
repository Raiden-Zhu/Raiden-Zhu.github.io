...
<small><em>"Uniqueness shapes who we are."</em></small>
...
- **Language model training** (e.g., optimizers, looped architectures, efficient parallel training);
- **Decentralized learning** (e.g., [generalization](https://arxiv.org/abs/2206.12680), [training dynamics](https://arxiv.org/abs/2306.02913), [data influence](https://openreview.net/forum?id=2TIYkqieKw), [communication allocation](https://openreview.net/forum?id=lWGMbJRCtQ));
